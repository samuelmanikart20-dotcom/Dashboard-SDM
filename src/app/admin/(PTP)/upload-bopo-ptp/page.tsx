...
export default function UploadBOPOPTPPage() {
  ...
  const downloadTemplate = () => {
    ...
    const keterangan = [
      "Konsolidasi PTP (Semua Daerah)",
      "PTP Cabang Pontianak",
      "PTP Kantor Pusat",
      "PTP Cabang Tanjung Priok",
      "PTP Cabang Banten",
      "PTP Cabang Cirebon",
      "PTP Cabang Pangka Balam",
      "PTP Cabang Tanjung Balam",
      "PTP Cabang Palembang",
      "PTP Cabang Teluk Bayur",
      "PTP Cabang Panjang",
      "PTP Cabang Bengkulu",
      "PTP Cabang Jambi",
    ];
    ...
    const rows = codes.map((code, index) => {
      if (index === 0) {
        ...
        return [
          ...
          "8", // bulan contoh
          "2024", // tahun contoh
          "83.2", // BOPO_RATIO contoh
          "750000000", // PRODUKTIVITAS_EFISIENSI contoh
          "44.1", // RASIO_BEBAN_PENGHASILAN_USAHA contoh
        ];
      } else {
        // baris lain hanya kode & keterangan
    ...
    a.href = url;
    a.download = "template-bopo-ptp.csv";
    a.click();
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/admin/upload-bopo-ptp", {
        method: "POST",
        body: fd,
      });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Upload BOPO PTP</h1>
        <p className="text-gray-600">
          Unggah file Excel/CSV untuk memperbarui tabel BOPO PTP
        </p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            Header: KODE, KETERANGAN, BULAN, TAHUN, BOPO_RATIO, PRODUKTIVITAS_EFISIENSI,
            RASIO_BEBAN_PENGHASILAN_USAHA. Gunakan KODE=ALL untuk Konsolidasi PTP (Semua Daerah).
            </p>
          </div>
          <button
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="text-center">
                <p className="text-gray-700 mb-2">
                  Anda akan mengupload data BOPO PTP
                </p>
