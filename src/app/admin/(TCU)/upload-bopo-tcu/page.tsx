...
export default function UploadBOPOTCUPage() {
  ...
  const downloadTemplate = () => {
    ...
    const sample = ['TCU-KP', '8', '2024', '87.3', '820000000', '46.5', 'Contoh data TCU'];
    const csv = [headers.join(';'), sample.join(';')].join('\n');
    const blob = new Blob([csv], { type: 'text/csv' });
    const url = URL.createObjectURL(blob);
    const a = document.createElement('a');
    a.href = url;
    a.download = 'template-bopo-tcu.csv';
    a.click();
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/admin/upload-bopo-tcu', { method: 'POST', body: fd });
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Upload BOPO TCU</h1>
        <p className="text-gray-600">Unggah file Excel/CSV untuk memperbarui tabel BOPO TCU</p>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-700">Header: KODE, BULAN, TAHUN, BOPO_RATIO, PRODUKTIVITAS_EFISIENSI, RASIO_BEBAN_PENGHASILAN_USAHA, KETERANGAN</p>
          </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="text-center">
                <p className="text-gray-700 mb-2">
                  Anda akan mengupload data BOPO TCU
                </p>
