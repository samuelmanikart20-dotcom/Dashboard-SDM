...
export async function GET(_request: NextRequest) {
  ...
  try {
    ...
    // Get distinct periods (bulan, tahun) from struktur_organisasi_tcu
    ...
    // Get distinct daerah from struktur_organisasi_tcu with join to daerah table
    ...
    // Get distinct directorates directly from struktur_organisasi_tcu
    ...
    console.error('GET /api/admin/(TCU)/tcu-struktur-organisasi/available-periods error', error);
    if (conn) {
      try {
        await conn.end();
      } catch {}
